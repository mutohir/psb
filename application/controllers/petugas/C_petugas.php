...
class C_petugas extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function data_pendaftar() {
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
		$petugas = $this->m_dashboard->get_all_pendaftar();
		$data['query'] = $petugas;
		$data['level'] = $this->session->userdata('level');
		$data['user_id'] = $this->session->userdata('user_id');
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/data_pendaftar', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	function form_add_santri(){
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/tambah_santri', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	function form_add_pendaftar(){
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/tambah_pendaftar', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
   ...
   //          }			
			...
			if ($this->m_dashboard->add_santri($datasantri,$datawali,$datauser)) {
				...
				redirect('petugas/C_petugas/','refresh');
			}
			else {
	...
	public function add_pendaftar()
	{
		...
		if ($this->M_dashboard->check_user_exist($data['username'])) {
			...
			redirect('petugas/C_petugas/data_pendaftar','refresh');
		}
		...
		// 		redirect('petugas/C_petugas/form_add_pendaftar','refresh');
		// 	}
		// 	redirect('petugas/C_petugas/add_pendaftar','refresh');
		// }
	}
   ...
   //      		redirect('petugas/C_petugas/','refresh');
		...
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_santri', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function edit_penerimaan($id)
	{
		...
		if (isset($_POST['edit'])) {
			...
			if ($this->m_dashboard->updatesantri($id)) {
				$this->session->set_flashdata('success', 'Data berhasil dirubah');
				redirect('petugas/C_petugas/penerimaan','refresh');
			}
			else {
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit','refresh');
			}
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_penerimaan', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function edit_pendaftar($id)
	{
		...
		if (isset($_POST['edit'])) {
			if ($this->m_dashboard->updatependaftar($id)) {
				...
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit_pendaftar','refresh');
			}
			redirect('petugas/C_petugas/data_pendaftar','refresh');
		}
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_pendaftar', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function lihat($id)
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/lihat_santri', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function lihat_pendaftar($id)
		{
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
		$data['petugas'] = $this->m_dashboard->getpendaftar($id);
		$data['level'] = $this->session->userdata('level');
		$data['user_id'] = $this->session->userdata('user_id');
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/lihat_pendaftar', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function panduan()
	{
		...
		$data['user_id'] = $this->session->userdata('user_id');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/panduan', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function biaya()
	{
		...
		$data['user_id'] = $this->session->userdata('user_id');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/biaya', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	function form_add_biaya(){
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/tambah_biaya', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function add_biaya()
	{
		...
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
			if ($this->m_dashboard->add_biaya()) {
				...
				redirect('petugas/C_petugas/biaya','refresh');
			}
			else {
				$this->session->set_flashdata('error', 'Data Biaya gagal ditambahkan. Silahkan coba lagi.');
				redirect('petugas/C_petugas/form_add_biaya','refresh');
			}
		}
	}
	public function edit_biaya($id)
	{
		...
		if (isset($_POST['edit'])) {
			if ($this->m_dashboard->updatebiaya($id)) {
				...
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit_biaya','refresh');
			}
		}
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_biaya', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function berkas()
	{
	  ...
	  $data['level'] = $this->session->userdata('level');
		$this->load->view('petugas/templates/header', $data);
	  $this->load->view('petugas/berkas', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function penerimaan()
	{
		...
		$data['user_id'] = $this->session->userdata('user_id');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/penerimaan', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function data_petugas() {
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
		$petugas = $this->m_dashboard->get_all_petugas();
		$data['query'] = $petugas;
		$data['level'] = $this->session->userdata('level');
		$data['user_id'] = $this->session->userdata('user_id');
		$data['username'] = $this->session->userdata('username');
	...
	public function add_petugas()
	{
		...
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
			if ($this->m_dashboard->add_petugas()) {
				...
				redirect('petugas/C_petugas/data_petugas','refresh');
			}
			else {
				$this->session->set_flashdata('error', 'Data petugas gagal ditambahkan. Silahkan coba lagi.');
				redirect('petugas/C_petugas/form_add_petugas','refresh');
			}
			redirect('petugas/C_petugas/add_petugas','refresh');
		}
	}
	public function edit_petugas($id)
	{
		...
		if (isset($_POST['edit'])) {
			if ($this->m_dashboard->updatepetugas($id)) {
				...
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit_petugas','refresh');
			}
			redirect('petugas/C_petugas/data_petugas','refresh');
		}
	...
	public function lihat_petugas($id)
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/lihat_petugas', $data);
				$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function jadwal()
		...
		$data['user_id'] = $this->session->userdata('user_id');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/jadwal', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function jadwal_ngaji()
		...
		$data['user_id'] = $this->session->userdata('user_id');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/jadwal_ngaji', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function edit_ngaji($id)
	{
		...
		if ($this->m_dashboard->updatengaji($id)) {
			$this->session->set_flashdata('success', 'Data berhasil dirubah');
			redirect('petugas/C_petugas/jadwal_ngaji','refresh');
		}
		else {
			$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
			redirect('petugas/C_petugas/edit_ngaji','refresh');
		}
		}
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_ngaji', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function add_jadwal()
	{
		...
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
			if ($this->m_dashboard->add_jadwal()) {
				...
				redirect('petugas/C_petugas/jadwal','refresh');
			}
			else {
				$this->session->set_flashdata('error', 'Data Jadwal gagal ditambahkan. Silahkan coba lagi.');
				redirect('petugas/C_petugas/form_add_jadwal','refresh');
			}
		}
	}
	public function add_jadwal_ngaji()
	{
		...
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
			if ($this->m_dashboard->add_jadwal_ngaji()) {
				...
				$this->session->set_flashdata('error', 'Data Jadwal gagal ditambahkan. Silahkan coba lagi.');
				redirect('petugas/C_petugas/form_add_jadwal_ngaji','refresh');
			}
		}
	}
	function form_add_jadwal(){
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/tambah_jadwal', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	function form_add_jadwal_ngaji(){
		$this->load->model('m_dashboard');
		$data['query'] = $this->m_dashboard->ngaji();
		$data['level'] = $this->session->userdata('level');
		$data['user_id'] = $this->session->userdata('user_id');
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/tambah_ngaji', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function edit_jadwal($id)
	{
		...
		if (isset($_POST['edit'])) {
			if ($this->m_dashboard->updatejadwal($id)) {
				...
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit_jadwal','refresh');
			}
		}
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_jadwal', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function add_panduan()
	{
		...
		$this->load->model('M_dashboard', 'm_dashboard', TRUE);
			if ($this->m_dashboard->add_panduan()) {
				$this->session->set_flashdata('success', 'Data Jadwal berhasil ditambahkan');
				redirect('petugas/C_petugas/panduan','refresh');
			}
			else {
				$this->session->set_flashdata('error', 'Data Jadwal gagal ditambahkan. Silahkan coba lagi.');
				redirect('petugas/C_petugas/form_add_panduan','refresh');
			}
		}
	}
	function form_add_panduan(){
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/tambah_panduan', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	public function edit_panduan($id)
	{
		...
		if (isset($_POST['edit'])) {
			if ($this->m_dashboard->updatepanduan($id)) {
				...
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit_panduan','refresh');
			}
		}
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_panduan', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
	...
	public function edit_profil($id)
	{
		...
		if (isset($_POST['edit'])) {
			if ($this->m_dashboard->updateprofil($id)) {
				$this->session->set_flashdata('success', 'Data berhasil dirubah');
				redirect('petugas/C_petugas/profil/'.$id,'refresh');
			}
			else {
				$this->session->set_flashdata('error', 'Data gagal dirubah. Silahkan coba lagi.');
				redirect('petugas/C_petugas/edit_profil','refresh');
			}
			redirect('petugas/C_petugas/profil/'.$id,'refresh');
		}
		...
		$data['user_id'] = $this->session->userdata('user_id');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_profil', $data);
			$this->load->view('petugas/templates/footer', $data);
	}
	public function form_foto_profil()
	{
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/edit_foto_profil', $data);
			$this->load->view('petugas/templates/footer', $data);
	}
	...
	$nmfile = "foto_".time();
	$config['upload_path']   = './uploads/';
	$config['allowed_types'] = 'gif|jpeg|bmp|jpg|png|pdf';
...
public function hapus($id)
  {
  	...
  	redirect('petugas/C_petugas/berkas','refresh');
  }
	...
	public function kebutuhan_santri()
		...
		$data['username'] = $this->session->userdata('username');
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/kebutuhan_santri', $data);
		$this->load->view('petugas/templates/footer', $data);
	}
