              ...
              <div class="dashboard-block" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                ...
                <div class="col-sm-9 clearfix">
                  ...
                  <div class="pull-right">
                    ...
                    <a href="<?php echo base_url('admin/C_admin/form_add_santri') ?>" class="pull-right" ><button class="btn btn-primary" name="add" type="submit"> <span class="fa fa-user-plus"> </span> Tambah</button></a>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php
                              ...
                              ?></td>
                          <td>
                            <a href="<?php echo base_url('admin/C_admin/lihat/') ?><?php echo $row->id_santri ?>" data-toggle="tooltip" title="Lihat"><button class="btn btn-info" role="button"><span class="fa fa-eye"></span></button></a>
                            <a href="<?php echo base_url('admin/C_admin/edit/') ?><?php echo $row->id_santri ?>" data-toggle="tooltip" title="Edit"><button class="btn btn-success" role="button"><span class="fa fa-edit"></span></button></a>
                            <!-- <a href="<?php echo base_url('admin/C_admin/laporan_pendaftar/') ?><?php echo $row->id_santri ?>" data-toggle="tooltip" title="Cetak" target="_blank"><button class="btn btn-warning" role="button"><span class="fa fa-print"></span></button></a> -->
                            <a href="<?php echo base_url('admin/C_admin/delete/') ?><?php echo $row->id_santri ?>" data-toggle="tooltip" title="Hapus"><button name="hapus" class="btn btn-danger" role="button" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><span class="fa fa-trash"></span></button></a>
                          </td>
                        </tr>
                      </tbody>
                      <?php } ?>
