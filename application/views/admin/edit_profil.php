<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
        <a style="margin-top: 15px;" href="<?php echo base_url('admin/C_admin/profil/'); ?><?php echo $user_id; ?>" data-toggle="tooltip" title="Kembali" class="pull-right"><button class="btn btn-primary fa fa-arrow-left pull-right"></button></a>
            ...
            <div class="panel panel-default">
                ...
                <div>
                    ...
                    <!-- <a href="<?php echo base_url('admin/C_admin/profil/'); ?><?php echo $user_id; ?>" class="pull-right"><span class="fa fa-arrow-left"> Kembali</span></a> -->
                </div>
            </form>
        </div>
        </div><!-- End Row -->
