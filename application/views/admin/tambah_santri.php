<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <hr>
            <form action="<?php echo base_url(); ?>admin/C_admin/add_santri" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                ...
                                <h4 style="text-transform: uppercase; font-weight: bold; padding-top: 10px; text-align: center; text-align: center;"> Data Santri</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="username" placeholder="Nama Akun" required></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="password" placeholder="Password Pengguna" required></td>
                                    </tr>
                                    <tr>
            ...
            <div role="tabpanel" class="tab-pane" id="tab">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td><label for="">No. Hp</label><span class="text-danger"> &#42;</span></td>
                            <td><input type="tel" class="form-control" name="telp_ayah"  placeholder="Nomor Handphone Ayah" required></td>
                        </tr>
                    </table>
                </div>
            </div>
