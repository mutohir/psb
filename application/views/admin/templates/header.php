  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url('admin/C_admin'); ?>" style="color: #FFFFFF; font-weight: bold;">PSB AL MUHSIN</a>
        </div>
        <ul class="nav navbar-nav navbar-right">
            <!-- <li>
              <a href="<?php echo base_url("admin/C_admin/logout") ?>"><button type="button" class="btn btn-danger"><span class="fa fa-sign-out"></span> Keluar</button></a>
            </li> -->
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color: #fff;"><i class="fa fa-cogs"></i>&nbsp;Pengaturan <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                  <li role="presentation"><a role="menuitem" href="<?php echo base_url('admin/C_admin/profil/'); ?><?php echo $user_id; ?>"><span class="fa fa-user"></span>  &nbsp;Profil</a></li>
                  <li role="presentation"><a role="menuitem" href="<?php echo base_url('admin/C_admin/logout'); ?>"><span class="fa fa-sign-out"></span> Keluar</a></li>
