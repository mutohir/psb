...
<h3 style="text-transform: uppercase; font-weight: bold;" class="text-center">Ubah Biodata Pendaftar</h3><hr>
    ...
    <div role="tabpanel">
        ...
        <h4 style="text-transform: uppercase; font-weight: bold; padding-top: 10px;"> Data Santri</h4>
            <tr>
                ...
                <td><input type="hidden" name="id_santri" value="<?php echo $santri->id_santri; ?>"><input type="hidden" name="id_wali" value="<?php echo $santri->id_wali; ?>"><input type="text" class="form-control" name="no_pendaftaran" value="<?php echo $santri->no_pendaftaran; ?>" readonly></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="form-control" name="tmp_lahir"  value="<?php echo $santri->tmp_lahir; ?>" style="width: 50%; float: left;" required><input type="text" class="form-control" id="datepicker" name="tgl_lahir" style="width: 50%;" value="<?php echo $santri->tgl_lahir; ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="tel" class="form-control" name="telp_santri" value="<?php echo $santri->telp_santri; ?>"><em><span class="help-block text-muted">*) Disarankan nomor Whatsapp</span></em></td>
            </tr>
            <tr>
    ...
    <div>
        ...
        <!-- <a href="<?php echo base_url('pendaftar/C_pendaftar/') ?>" class=""><span class="fa fa-arrow-left"> Kembali</span></a> -->
    </div>
    </div>
</form>
</div>
