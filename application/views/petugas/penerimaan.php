                ...
                <tbody>
                        ...
                        <tr>
                          ...
                          <?php
                              ...
                              <a href="<?php echo base_url('petugas/C_petugas/edit_penerimaan/') ?><?php echo $query->id_santri ?>" data-toggle="tooltip" title="Edit"><button class="btn btn-success" role="button"><span class="fa fa-edit"></span></button></a>
                              <a href="<?php echo base_url('petugas/C_petugas/laporan_pendaftar/') ?><?php echo $query->id_santri ?>" data-toggle="tooltip" title="Cetak" target="_blank"><button class="btn btn-warning" role="button"><span class="fa fa-print"></span></button></a>
                          </td>
                        </tr>         
                        <?php } ?>
                </tbody>
